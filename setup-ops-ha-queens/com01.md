...
Cấu hình network:
```
nmcli con mod eth0 ipv4.address 10.10.34.164/24
nmcli con mod eth0 ipv4.gateway 10.10.34.1
nmcli con mod eth0 ipv4.dns 8.8.8.8
nmcli con mod eth0 ipv4.method manual
nmcli con mod eth0 connection.autoconnect yes

nmcli con mod eth1 ipv4.address 10.10.31.164/24
nmcli con mod eth1 ipv4.method manual
nmcli con mod eth1 connection.autoconnect yes

nmcli con mod eth2 ipv4.address 10.10.32.164/24
nmcli con mod eth2 ipv4.method manual
nmcli con mod eth2 connection.autoconnect yes

nmcli con mod eth3 ipv4.address 10.10.33.164/24
...
server_proxyclient_address = 10.10.34.164
...
+----+------------------+-------+----------+---------+-------+----------------------------+
|  1 | nova-consoleauth | ctl01 | internal | enabled | up    | 2020-11-18T10:01:17.000000 |
|  4 | nova-conductor   | ctl01 | internal | enabled | up    | 2020-11-18T10:01:16.000000 |
|  7 | nova-scheduler   | ctl01 | internal | enabled | up    | 2020-11-18T10:01:17.000000 |
| 25 | nova-consoleauth | ctl02 | internal | enabled | up    | 2020-11-18T10:01:21.000000 |
| 28 | nova-scheduler   | ctl02 | internal | enabled | up    | 2020-11-18T10:01:19.000000 |
| 31 | nova-conductor   | ctl02 | internal | enabled | up    | 2020-11-18T10:01:22.000000 |
| 46 | nova-consoleauth | ctl03 | internal | enabled | up    | 2020-11-18T10:01:19.000000 |
| 49 | nova-scheduler   | ctl03 | internal | enabled | up    | 2020-11-18T10:01:21.000000 |
| 52 | nova-conductor   | ctl03 | internal | enabled | up    | 2020-11-18T10:01:20.000000 |
| 68 | nova-compute     | com01 | nova     | enabled | up    | 2020-11-18T10:01:15.000000 |
+----+------------------+-------+----------+---------+-------+----------------------------+
```
...
- Tắt tất cả service neutron, nova, glance, horizon tại CTL 2 CTL3, test tạo mới với CTL 1 up, thực hiện truy cập giao diện, cấu hình Network, tạo mới Flavor, boot VM http://10.10.34.170/
- Tắt tất cả service neutron, nova, glance, horizon tại CTL 1 CTL3, test tạo mới với CTL 2 up, thực hiện truy cập giao diện, cấu hình Network, tạo mới Flavor, boot VM http://10.10.34.170/
- Tắt tất cả service neutron, nova, glance, horizon tại CTL 1 CTL2, test tạo mới với CTL 3 up, thực hiện truy cập giao diện, cấu hình Network, tạo mới Flavor, boot VM http://10.10.34.170/
- Bật đầy đủ cả 3 node, thực hiện truy cập giao diện, cấu hình Network, tạo mới Flavor, boot VM http://10.10.34.170/
